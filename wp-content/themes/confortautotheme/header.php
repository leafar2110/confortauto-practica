...
<head <?= language_attributes();?>>
	...
	<meta property="og:url"           content="<?php bloginfo('template_url'); ?>" />
	  ...
	  <link href="https://fonts.googleapis.com/css?family=Karla|Lora|Open+Sans+Condensed:300|Raleway|Oswald|Roboto+Mono|Josefin+Sans|Catamaran" rel="stylesheet">
...
<body <?= body_class()?>>
    ...
    <header class="main-header">
            ...
            <div class="navbar-top">
              <nav class="navbar">
                <div class="container">
                  ...
                  <form class="search-navbar navbar-form navsearch1 navbar-left" action="/action_page.php">
                  ...
                  <ul class="nav navbar-nav navbar-right navbar-btns navbar1">
                    ...
                    <li id="kart"><a href="#"><span class="glyphicon glyphicon-shopping-cart"></span></a></li>
                  </ul>
                </div>
              </nav>
        ...
        <form class="search-navbar navbar-form navsearch2 navbar-left" action="/action_page.php">
            <div class="form-group">
              <input type="text" class="form-control" placeholder="Quiero buscar...">
            </div>
            <button type="submit" class="btn btn-default"><span class="glyphicon glyphicon-search"></span></button>
